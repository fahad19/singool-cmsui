...
(function(/*! Stitch !*/) {
  ...
  AppHelper = (function(_super) {
    ...
    function AppHelper() {
      return AppHelper.__super__.constructor.apply(this, arguments);
    }
  ...
  BlocksForm = (function(_super) {
    ...
    function BlocksForm() {
      return BlocksForm.__super__.constructor.apply(this, arguments);
    }
  ...
  BlocksIndex = (function(_super) {
    ...
    function BlocksIndex() {
      return BlocksIndex.__super__.constructor.apply(this, arguments);
    }
  ...
  BlocksRow = (function(_super) {
    ...
    function BlocksRow() {
      return BlocksRow.__super__.constructor.apply(this, arguments);
    }
  ...
  UsersForm = (function(_super) {
    ...
    function UsersForm() {
      return UsersForm.__super__.constructor.apply(this, arguments);
    }
  ...
  UsersRow = (function(_super) {
    ...
    function UsersRow() {
      return UsersRow.__super__.constructor.apply(this, arguments);
    }
  ...
  UsersShow = (function(_super) {
    ...
    function UsersShow() {
      return UsersShow.__super__.constructor.apply(this, arguments);
    }
  ...
  Helper = (function(_super) {
    ...
    Helper.prototype.beforeRender = function() {};

    Helper.prototype.afterRender = function() {};
  ...
  FormHelper = (function(_super) {
    ...
    function FormHelper() {
      return FormHelper.__super__.constructor.apply(this, arguments);
    }
    ...
    FormHelper.prototype.inputs = function() {
      var field, options, out, _ref;
      out = '';
      _ref = this.model.schema;
      for (field in _ref) {
        options = _ref[field];
    ...
    FormHelper.prototype.object = function(field, options) {
      var $out, fieldOptions, name, objectField, out, _ref;
      options = _.defaults(options, this.defaults.field);
      ...
      $out.html(out);
      _ref = options.schema;
      for (objectField in _ref) {
        fieldOptions = _ref[objectField];
    ...
    FormHelper.prototype.showErrors = function(form, model) {
      var controlGroup, controls, error, errors, field, message, messages, _ref, _results;
      this.clearErrors(form);
      _ref = model.validationErrors;
      _results = [];
      for (field in _ref) {
        errors = _ref[field];
  ...
  HtmlHelper = (function(_super) {
    ...
    function HtmlHelper() {
      return HtmlHelper.__super__.constructor.apply(this, arguments);
    }
  ...
  Model = (function(_super) {
    ...
    Model.prototype.extract = function(form) {
      var attr, field, fields, k, out, subField, v, _ref;
      attr = {};
    ...
    Model.prototype.validates = function(attributes) {
      var check, field, ruleName, schema, validation, value, _ref, _ref1;
      if (attributes == null) {
        attributes = null;
      }
      if (!attributes) {
      ...
      for (field in attributes) {
        ...
        if (((_ref = schema[field]) != null ? _ref.validate : void 0) != null) {
          _ref1 = schema[field].validate;
          for (ruleName in _ref1) {
            validation = _ref1[ruleName];
            check = true;
    ...
    Model.prototype.getFlattenedSchema = function() {
      var field, fieldOptions, name, objectField, options, out, _ref, _ref1;
      out = {};
      _ref = this.schema;
      for (field in _ref) {
        options = _ref[field];
  ...
  View = (function(_super) {
    ...
    function View(options) {
      ...
      this.render = _.wrap(this.render, function(render) {
        var h, helper, _ref1, _ref2;
        _ref1 = _this.helpers;
        for (helper in _ref1) {
          h = _ref1[helper];
          _this[helper].beforeRender();
        }
        _this.beforeRender();
        render();
        _ref2 = _this.helpers;
